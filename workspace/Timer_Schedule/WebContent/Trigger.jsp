...
<body bgcolor="#D3D3DB">
	...
	<form action="Trigger" method="post">
		<table align="center">
			<tr align="center">
				<td align="center" style="font-size: 32px; color: blue;">Mutha Group Satara</td>
			</tr>
			<tr align="center">

				<td align="center" style="font-size: 20px; color: green;">Timer Solution </td>
			</tr>
			<tr>
				<td align="center"><br /> <br /> <br /> <input type="submit" class="myButton" value="Start Timer Solution"></td>
			</tr>
		</table> 
	</form>
